    ...
    <InvitationStyledWrapper className="container text-center">
      ...
      <IntroImagesSection>
        ...
        <div className="secondImage">
          <img
            className="w-100"
            src="/my-wedding/assets/images/invitation/invitation2.jpg"
      ...
      <AdditionalImagesSection>
        <div>
          <img
            className="w-100"
            src="/my-wedding/assets/images/invitation/invitation3.jpg"
        ...
        <div>
          <img
            className="w-100"
            src="/my-wedding/assets/images/invitation/invitation6.jpg"
        ...
        <div>
          <img
            className="w-100"
            src="/my-wedding/assets/images/invitation/invitation5.jpg"
